...
class Calculadora(QMainWindow):
	def __init__(self, parent=None):
		...
		self.display.setStyleSheet(
			'* {background: #FFF; color: #000; font-size: 60px;}'
		)
		...
		self.add_btn(
			QPushButton('+'), 1, 3, 1, 1,
			style='background: #A4A4A4; color: #fff; font-weight: 700;'
		)
		self.add_btn(
		...
		self.add_btn(
			...
			'background: #10C116; color: #fff; font-weight: 700;'
		)
		...
		self.add_btn(
			QPushButton('='), 4, 4, 1, 1,
			self.eval_igual,
			'background: #5D6057; color: #fff; font-weight: 700;'
		)
